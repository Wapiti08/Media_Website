        ...
        <div class="news_box">
            ...
            <div class="news_box_content">
                <asp:Repeater ID="repChina" runat="server">
                    <ItemTemplate>
                        <a href="NewsShow.aspx?id=<%#Eval("keywordsID") %>">·<%#Eval("NewsTitle").ToString().Trim().Length > 18 ? Eval("NewsTitle").ToString().Trim().Substring(0, 18) : Eval("NewsTitle").ToString().Trim()%></a><br />
                    </ItemTemplate>
                </asp:Repeater>
            </div>
        </div>
        <div class="news_box">
            ...
            <div class="news_box_content">
                <asp:Repeater ID="repFinance" runat="server">
                    <ItemTemplate>
                        <a href="NewsShow.aspx?id=<%#Eval("keywordsID") %>">·<%#Eval("keywordsTitle").ToString().Trim().Length > 18 ? Eval("keywordsTitle").ToString().Trim().Substring(0, 18) : Eval("NewsTitle").ToString().Trim()%></a><br />
                    </ItemTemplate>
                </asp:Repeater>
            </div>
        </div>
